...
const translations = {
  en: {
    ...
    vehicleNamePlaceholder: 'Example: All New Avanza / NMAX',
    ...
    existingLoanLabel: 'Any Ongoing Installments?',
    loanNo: 'No',
    loanYes: 'Yes',
    ...
    summaryTotalIncome: 'Total monthly income',
    summaryExistingInstallment: 'Any ongoing installments?',
  ...
  id: {
    ...
    vehicleNamePlaceholder: 'Contoh: All New Avanza / NMAX',
